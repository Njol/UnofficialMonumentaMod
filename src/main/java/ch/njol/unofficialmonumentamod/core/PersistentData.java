...
public class PersistentData {
    ...
    private static void load() {
        ...
        try (FileReader reader = new FileReader(file)) {
            ...
            UnofficialMonumentaModClient.LOGGER.error("Caught IO error whilst trying to load persistent data", e);
        }
    }
    ...
    private static void save() {
        ...
        if (!file.exists()) {
            try {
                ...
                UnofficialMonumentaModClient.LOGGER.error("Caught IO error whilst trying to create files for persistent data", e);
            }
        }
    ...
    public interface PersistentDataLoadedCallback {
        Event<PersistentDataLoadedCallback> EVENT = EventFactory.createArrayBacked(PersistentDataLoadedCallback.class, (listeners) -> (persistentData) -> {
    ...
    public interface PersistentDataSavingCallback {
        Event<PersistentDataSavingCallback> EVENT = EventFactory.createArrayBacked(PersistentDataSavingCallback.class, (listeners) -> (persistentData) -> {
